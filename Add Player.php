...
<div class="flex flex-col items-center ">
    <div style="max-width:500px; flex flex-col items-center">
        ...
        <div class="grid md:grid-cols-4 md:gap-6 relative z-[20]">
            <div class="relative z-0 w-full mb-5 group">
                <input required style="color:white;" type="number" name="divingpace" id="divingpace" class="block ForInput text-white py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
