...
<div class="mt-2">
    ...
    <div class="grid grid-cols-1 gap-8 p-4 lg:grid-cols-2 xl:grid-cols-2">
        <!-- All Players Count -->
        <div class="flex items-center bg-red p-4 bg-white rounded-md dark:bg-darker">
            <div class="flex w-full h-full gap-5 flex-col">
                ...
                <p class="text-xl font-semibold"><?php echo $row["COUNT"] ?> Player</p>
            </div>
            <div>
                <i style="color:#8b5cf6;font-size:40px;" class="fa-solid fa-users"></i>
            </div>
        </div>
        ...
        <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
            <div class="flex flex-col gap-4 justify-between">
                ...
                <div class="flex gap-5  ">
                    <div style="width:50px; border-radius:8px; overflow:hidden;">
