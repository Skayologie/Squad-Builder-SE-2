              ...
              <div x-data="{ isActive: true, open: true}">
                ...
                <div role="menu" x-show="open" class="mt-2 space-y-2 px-7" aria-label="Dashboards">
                  ...
                  <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                    ...
                    <div onclick="AddPlayer()" href="#" role="menuitem" class="flex  items-center gap-3  p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700" >
        ...
        >
          ...
          <div class="flex flex-col h-screen">
            ...
            <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden h hover:overflow-y-auto">
              <h3 class="py-2 text-sm font-semibold text-gray-600 dark:text-light"></h3>
